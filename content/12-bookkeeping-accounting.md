...
### Built for
Built for: small businesses and their bookkeepers or accountants who want the US-standard general ledger, invoicing, payroll, and tax-ready books.

Best fit: the safe default when you need an accountant who already knows the tool and deep third-party integrations, over leaner or newer options.

### What it is
Intuit's cloud accounting platform and the long-standing US standard, most familiar to US accountants. It offers add-on payroll and a wide integration ecosystem, with paid tiers running from Simple Start ($38/mo) to Advanced ($340/mo) after the Aug 1, 2026 increase. Intuit also offers QuickBooks Free, a separate $0/mo product distinct from these QuickBooks Online paid tiers.

### Accountant fit, geography & access
...
Ideal for: SMBs and founders who want the software every US bookkeeper and CPA already knows.

Best when: universal accountant support and ecosystem depth matter more than startup-specific features: paid tiers Simple Start $38, Essentials $85, Plus $140 and Advanced $340/mo after the Aug 1, 2026 hike (Intuit's QuickBooks Free is a separate $0 product), with the deepest app marketplace and payroll/payments integrations. Choose it over Xero when you're US-only and want the largest pool of QBO-fluent bookkeepers, and over Puzzle when you're an operating small business rather than a burn-tracking venture startup.

Avoid if: you're VC-backed and need daily runway, simultaneous cash+accrual GAAP books and SaaS rev-rec (go Puzzle), or you're pre-revenue and want free (go Wave or QuickBooks Free).
...
### Built for
Built for: small businesses and accounting firms, strong outside the US, wanting clean double-entry books, unlimited users, and a broad app ecosystem.

Best fit: choose it over QuickBooks for better multi-user pricing and international workflows, especially outside North America.

### What it is
Full-featured cloud accounting offering full double-entry books on every plan, with unlimited users included at each tier and 1,000+ integrations. US tiers run Early ($25/mo), Growing ($55/mo) and Established ($90/mo, which adds multi-currency). Aimed at growing businesses.
...
### AI automation
Automation centers on bank reconciliation. Matching imported transactions to reduce manual coding. It's targeted at the highest-volume bookkeeping task, not a broad AI layer across the product.
...
### Choose this if you are…
Ideal for: small teams and international founders who want multiple people in the books without per-seat fees.

Best when: collaboration and global basics drive the choice. Plans from ~$25/mo with unlimited users at no extra charge (versus QBO's tier-gated user counts), strong multi-currency and bank-feed support on higher tiers. Pick it over QuickBooks when several teammates or an overseas contractor accountant all need access and you don't want to pay per head, and over Puzzle when you're a normal small business, not a US venture startup needing GAAP burn reporting.

Avoid if: you specifically need the widest US CPA familiarity (QBO wins there) or startup-native accrual/runway/rev-rec built in (go Puzzle); Xero's US bookkeeper pool is thinner than QBO's.
...
### Built for
Built for: freelancers, sole proprietors, and very small businesses wanting free invoicing and basic accounting with minimal bookkeeping knowledge.

Best fit: the right call when budget is zero and needs are simple, before you outgrow it into QuickBooks or Xero.

### What it is
Core accounting and invoicing offered free at the Starter tier ($0/mo). Built for freelancers, sole proprietors and very small businesses under $500K revenue. A Pro tier ($19/mo) adds bank auto-import and multi-user access; receipt scanning is a separate add-on ($8/mo on Pro, $11/mo on Starter).
...
### Choose this if you are…
Ideal for: solo founders, freelancers, and pre-revenue startups who want real accounting and invoicing for $0.

Best when: you're keeping costs at zero and volume is low. Core accounting and unlimited invoicing are free, with Pro at $19/mo adding bank feeds and multi-user access (receipt scanning is a separate add-on at $8-11/mo). Choose it over Zoho Books when you want genuinely free over a $15 Standard plan, and over Puzzle/QBO when you don't yet have the volume or investors to justify paid software.

Avoid if: you need burn/runway and accrual GAAP for a raise (go Puzzle), inventory tracking (go Zoho Books Professional at $40), or the CPA-universal standard for a growing team (go QuickBooks); Wave's reporting and integrations are thin.
...
### Built for
Built for: startup founders and finance-savvy operators who want accrual-based, real-time books built for venture metrics and runway.

Best fit: pick it over QuickBooks when you are a tech startup wanting modern, automated accounting tied to burn and runway instead of legacy small-business books.

### What it is
AI-native accounting built for tech startups, centered on accrual and investor-ready books. Plans are Starter $30/mo (first 2 months free), Core $72/mo, Complete $120/mo and Scale $360/mo (about 17% off billed annually). It targets founders who want modern books over accountant-default tools.
...
### AI automation
AI-native automation is the core differentiator. The product is built around automating startup accounting. This is the main reason a founder would reach for it over the incumbent tools.
...
### Choose this if you are…
Ideal for: VC-backed US startups that must show investors accurate burn, runway, and GAAP-clean books from day one.

Best when: you need startup-native accounting QBO and Xero were never built for: AI-native with simultaneous cash and accrual books, daily burn/runway, and SaaS revenue recognition. Starter is free for the first 2 months, then $30/mo (1 seat), Core $72 (5 seats), Complete $120 and Scale $360 (unlimited seats; ~17% off annually). Pick it over QuickBooks/Xero when board reporting and fundraising diligence demand accrual and runway automatically, not as manual add-ons.

Avoid if: you're a non-venture SMB where a bookkeeper's QBO familiarity matters more (go QuickBooks), you want free forever (go Wave), or you'd rather outsource the work entirely to humans (go Pilot).
...
### Built for
Built for: small and mid-size businesses already using or considering the Zoho suite, wanting affordable accounting with automation and inventory.

Best fit: best when you want a low-cost, feature-rich ledger that plugs into Zoho CRM and apps, over standalone incumbents.

### What it is
Full-featured accounting from Zoho, with a free-forever plan for businesses under $50K revenue and a deep integrated app suite. Even the free plan carries bank reconciliation and 50+ reports; paid tiers run from Standard ($15/mo) up to ~$240/mo. Aimed at micro-businesses and founders.
...
### Choose this if you are…
Ideal for: bootstrapped founders who need real inventory tracking and a full back-office suite on a genuinely cheap plan (free under $50K revenue).

Best when: value and inventory drive the pick: free under $50K annual revenue, Standard $15/mo, Professional $40/mo (unlocks inventory), scaling to $120 Elite and $240 Ultimate, with tight Zoho CRM/Inventory/Mail integration; choose it over Wave when you want more usable free functionality and inventory that Wave lacks, and over QuickBooks when you'd rather stay inside Zoho's suite than pay QBO's higher, recently-raised tiers.

Avoid if: your accountant expects QuickBooks (go QBO), you're a venture startup needing accrual burn/runway (go Puzzle), or you want a truly zero-cost invoicing-first tool (Wave's free tier is simpler).
...
### Built for
Built for: funded startups and growing companies that want to outsource bookkeeping to a human team rather than run software themselves.

Best fit: choose it when you would rather hand off monthly close, tax, and CFO support than do the books in-house.

### What it is
A managed bookkeeping service (not DIY software). Pilot's US team runs your books monthly on QuickBooks Online, with optional tax, CFO and payroll add-ons.
...
### Choose this if you are…
Ideal for: funded founders who want to hand bookkeeping to humans and never open accounting software.

Best when: you'd rather buy the outcome than run the tool: managed US-based bookkeepers on accrual basis, with an Essentials tier around $99/mo for very low-expense companies stepping up to Core at ~$499+/mo (rising with monthly spend), plus optional tax and CFO services; choose Pilot over Puzzle/QBO/Xero when your scarce resource is founder time and you want a real team owning the monthly close instead of a dashboard you maintain.
...
### What it is
A manual double-entry (or cash-basis) ledger in Google Sheets/Excel: categorize every transaction from bank/card exports yourself, reconcile monthly, hand the file to a CPA for taxes. No QuickBooks/Bench/Pilot.
...
### Choose this if you are…
Ideal for: extremely early or pre-revenue founders with a handful of transactions a month.

Best when: volume is trivial and cash is precious. A simple spreadsheet ledger plus a part-time CPA for quarterly cleanup and taxes costs almost nothing and keeps you close to the numbers; choose this over Wave/QBO when even a free tool is overkill and you'd rather not learn software yet, deferring real tooling until transactions or investors demand it.

Avoid if: you're doing more than ~20-30 transactions a month, taking investor money, or need accrual GAAP and audit-ready books; reconciliations and rev-rec bury a spreadsheet fast; graduate to Wave, QuickBooks, or Puzzle.
