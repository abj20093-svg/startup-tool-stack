...
### Built for
Built for: product-led SaaS companies with support and success teams wanting in-app messaging, AI resolution, and proactive engagement.

Best fit: the pick when live chat, in-product onboarding, and an AI agent like Fin matter more than classic ticket queues, and you can pay for it.

### What it is
An omnichannel customer messaging and support suite built around the Fin AI agent. It covers chat, email, in-app messaging and social in one workspace, and is aimed at teams wanting a messaging-first support setup with an AI agent handling front-line conversations.
...
### Ticketing, routing, SLAs & reporting
...
Ideal for: product-led SaaS teams that want in-app messaging plus an AI agent deflecting tickets.

Best when: you want Fin wired into the messenger: seats at $29/$85/$132 per agent/mo (Essential/Advanced/Expert, annual) plus Fin at $0.99 per resolution. Choose it over Help Scout/Zendesk when AI deflection and product tours/proactive messaging are the point, not just a shared inbox.

Avoid if: costs must be predictable and you're volume-heavy; Fin's per-resolution meter makes bills climb (8 agents + ~2,100 resolutions ≈ $2,800/mo); for calmer email support go Help Scout, for flat-rate go Crisp, and for open-source control go Chatwoot.
...
### Built for
Built for: small to mid-size teams wanting a shared inbox and simple help center without the complexity or price of enterprise tools.

Best fit: right when email-centric, human support with light automation is the goal, over heavier chat-first or enterprise suites.

### What it is
An email-first help desk organized around a shared inbox, with AI Answers layered on top. It targets small teams that want a shared inbox plus a knowledge base without heavy ticketing, covering email, chat and a knowledge base as its core channels.
...
### Choose this if you are…
Ideal for: small teams who want email-first, human, uncluttered support that feels personal.

Best when: you value a clean shared inbox over a sprawling ticketing suite: Standard $25, Plus $45, Pro $75 per user/mo (monthly; roughly 16% less billed annually) with an AI Answers add-on at $0.75 per resolution, staying affordable up to ~25 agents; choose it over Intercom when you don't need Fin-grade AI or heavy in-app messaging and want simpler per-seat pricing, and over Zendesk when Zendesk's depth would just be overhead.

Avoid if: you need the strongest AI deflection (go Intercom's Fin), enterprise routing/CSAT/WFM depth at scale (go Zendesk), a free self-hostable option (go Chatwoot), or flat non-per-seat billing for a big team (go Crisp).
...
### Built for
Built for: growing support teams wanting a full ticketing helpdesk with multichannel, automations, and tiered pricing that scales.

Best fit: choose it over Zendesk when you want comparable ticketing at friendlier pricing for a mid-market team.

### What it is
A ticketing help desk covering SLAs, routing and reporting. It is aimed at teams wanting classic ticket-based support with SLA and reporting depth, spanning email, chat, phone and social, and it offers automations and the Freddy AI assistant.
...
### Choose this if you are…
Ideal for: cost-conscious teams that want a full ticketing suite with the cheapest per-seat entry.

Best when: budget per agent is the deciding factor: free for 1-2 agents for 6 months, then Growth $19, Pro $55, Enterprise $89 per agent/mo (annual), with a Freddy AI Copilot add-on at ~$29/agent. Choose it over Zendesk when you want comparable ticketing, SLAs and automation at a materially lower seat price, and over Help Scout when you need fuller helpdesk structure (SLAs, ticket fields, portals) rather than a lean inbox.

Avoid if: you want stronger AI deflection and product messaging (go Intercom), a truly free self-hosted stack (go Chatwoot), or flat workspace pricing instead of per-agent (go Crisp).
...
### Built for
Built for: startups and small businesses wanting an affordable all-in-one chat, shared inbox, and chatbot widget on their site.

Best fit: the budget-friendly live-chat-first choice for small teams, versus pricier Intercom or ticket-heavy incumbents.

### What it is
A support and chat platform priced per workspace rather than per seat, with a native Hugo AI agent. It bundles AI credits into each plan and targets small teams that want flat per-workspace pricing, covering chat, email and social.
...
### Choose this if you are…
Ideal for: small-to-mid teams of ~10-20 who get penalized by per-seat pricing and want everything flat.

Best when: predictable flat-rate billing wins: Mini at $45/mo flat for 4 seats and Essentials at $95/mo for 10 seats, bundling live chat, shared inbox, chatbot and a CRM without per-agent fees, cutting costs 50-67% versus per-seat rivals for teams that size. Choose it over Freshdesk/Zendesk/Intercom when adding agents shouldn't inflate the bill.

Avoid if: you want Intercom's Fin for AI deflection, enterprise routing/reporting/WFM (go Zendesk), the personal email experience for a tiny team (go Help Scout), or full source-code control and self-hosting (go Chatwoot).
...
### Built for
Built for: engineering-minded teams wanting an open-source, self-hostable support inbox for chat, email, and social channels.

Best fit: pick it when data control, self-hosting, or avoiding per-seat SaaS fees outweighs turnkey convenience.

### What it is
An open-source (MIT), self-hostable omnichannel support platform positioned as an alternative to Intercom, Zendesk and Salesforce Service Cloud. It runs self-hosted or on cloud and suits teams with engineering capacity that want data ownership and low cost.
...
### Choose this if you are…
Ideal for: technical teams that want an open-source, self-hostable helpdesk they fully control.

Best when: data ownership and cost-at-scale matter: free open-source Community edition to self-host, or cloud tiers Startups $19, Business $39, Enterprise $99 per agent/mo, with an omnichannel inbox and Captain AI credits. Choose it over Crisp/Help Scout when you want to run it on your own infrastructure and avoid per-seat lock-in long-term, and over the DIY shared Gmail when you've outgrown a raw inbox but won't pay Zendesk/Intercom prices.

Avoid if: you don't want to run and maintain servers/updates (go Crisp or Help Scout for hosted simplicity) or you need turnkey AI deflection out of the box (go Intercom's Fin).
...
### Built for
Built for: larger support organizations and enterprises needing detailed ticketing, omnichannel, reporting, and many integrations at scale. / Best fit: Suited to a big team with complex workflows and compliance needs that outgrow lighter helpdesks.

### What it is
A cloud customer-service platform centered on omnichannel ticketing, sold as the Zendesk Suite. Unifies support requests from every channel into one agent workspace with automation, knowledge base, AI and analytics.
...
### Choose this if you are…
Ideal for: scaling mid-market and enterprise support orgs that need deep routing, SLAs, reporting, and WFM.

Best when: breadth and enterprise features justify the premium: Suite Team $55, Professional $115 per agent/mo, Enterprise custom, with a Copilot AI add-on at ~$50/agent. A realistic mid-market all-in lands $165-$265/agent once QA/WFM/AI stack up. Choose it over Freshdesk/Help Scout when you genuinely need advanced omnichannel routing, granular SLAs and analytics at scale, not just a good inbox.
...
### What it is
A shared support@ inbox (Google Groups/Gmail delegation) as your ticket queue, plus open-source Chatwoot (self-hosted on your own VPS) if you want live chat and multi-channel, replacing Zendesk/Intercom.
...
### Integrations & API
Chatwoot ships a full REST API and webhooks. Gmail has the Gmail API. You wire CRM/billing links yourself. Flexible but integration is code you write and maintain, with no marketplace of one-click apps.
...
### Choose this if you are…
Ideal for: pre-launch or tiny teams handling a trickle of support with near-zero budget.

Best when: volume is low and you want $0 tooling: a shared Gmail/Google Group inbox with labels and canned responses covers early support, and you can self-host Chatwoot Community free once you need assignment, omnichannel or basic automation; choose this over any paid helpdesk when ticket volume doesn't yet justify per-seat fees and you'd rather spend engineering time than SaaS dollars.

Avoid if: you need SLAs, collision detection, reporting, or AI deflection, or support is becoming a real function; a shared inbox loses tickets and has no metrics; move to Help Scout or Freshdesk for hosted structure, Crisp for flat pricing, or Intercom for AI.
