...
### Built for
Built for: pre-seed and seed founders, often solo or a small technical team, forming a Delaware C-corp to raise venture money and issue equity.

Best fit: the right call when you want a fast, standardized C-corp with a bank account and Stripe payments wired in, versus law-firm-grade or state-flexible setups.

### What it is
A bundled US formation product that pairs the incorporation filing with an EIN, a US bank account and founder stock paperwork, delivered within about two business days. Runs on a single $500 one-time fee covering formation, EIN and the first-year registered agent, now supports both a Delaware C-Corp and an LLC (chosen at onboarding), and is open to founders based anywhere.

### Structures & states supported
...
### Formation documents & legal support
...
Ideal for: US founders on the venture track who want a Delaware C-corp and a bank in one weekend.

Best when: you value the bundled ecosystem. $500 one-time covers formation, the $90 DE state fee, EIN, founder stock issuance with an 83(b) workflow, and year-one registered agent ($100/yr after), plus ~$2,500 Stripe credits and $50K+ in Mercury/AWS/Xero perks. Pick it over Clerky when you want turnkey banking and credits, and over Firstbase when you're US-based (Firstbase is tuned for non-residents).

Avoid if: you need attorney-grade, negotiable financing docs (go Clerky) or the cheapest private LLC (go Northwest); Atlas now forms both a C-corp and an LLC, but only in Delaware.
...
### Built for
Built for: first-time startup founders and their lawyers handling C-corp formation, 83(b) elections, SAFEs, and equity paperwork with legal precision.

Best fit: pick it over Atlas when clean, VC-ready cap-table and financing documents matter more than speed or bundled banking.

### What it is
A document-generation platform for Delaware C-Corp incorporation and the post-incorporation paperwork startups accumulate: founder stock with vesting, bylaws, IP assignment and board consents. Company setup starts at $427, with no banking or payments layer bundled in. Oriented toward companies that expect to raise.
...
### Choose this if you are…
Ideal for: founders who will run their own SAFEs, option grants, and priced rounds and want lawyer-trusted paperwork.

Best when: legal correctness beats onboarding polish. $427 per-use incorporation (+ state fees) or an $819 Company Lifetime Package bundling expedited filing, year-one registered agent, annual-report reminders and lifetime document workflows. Choose it over Stripe Atlas when your bottleneck is airtight, YC/attorney-standard docs rather than banking credits, and over Northwest when you're a C-corp raising money, not an LLC.

Avoid if: you want the banking-and-perks bundle (go Atlas), a non-resident package with a US address (go Firstbase/doola), or just cheap registered-agent service (go Northwest).
...
### Built for
Built for: non-US and remote founders incorporating a US LLC or C-corp remotely, plus small teams wanting ongoing compliance handled.

Best fit: choose it when you need US entity plus EIN, registered agent, and tax filings managed for a foreign or distributed founder, not just the initial filing.

### What it is
An incorporation platform that combines LLC or C-Corp formation with ongoing compliance, bookkeeping and tax services, and is usable by non-resident founders. Formation runs $399 one-time with lifetime support, while compliance and tax functions are sold as separate recurring add-ons rather than included in the base.
...
### Formation documents & legal support
Produces the standard formation documents and includes lifetime support with the $399 Start plan. The document set is geared to getting the entity formed; deeper equity and governance paperwork is not the platform's emphasis, which leans instead toward ongoing compliance and bookkeeping.
...
### Choose this if you are…
Ideal for: non-US founders who need a US Delaware or Wyoming entity, EIN, and address without a US SSN.

Best when: you're overseas and want state filing fees baked into one $399 one-time price (EIN expedited, core docs, RA ~$299/yr after), with an optional non-resident tax filing at ~$899/yr that undercuts doola's $1,999 tier. Pick it over doola when you prefer a one-time formation fee over a recurring $297/yr subscription, and over Stripe Atlas/Clerky which assume a US-resident founder.

Avoid if: you're US-based and VC-track (Atlas/Clerky fit better and unlock banking perks) or you just want the cheapest private US LLC (Northwest at ~$575+ over 5 years).
...
### Built for
Built for: solopreneurs, e-commerce sellers, and international founders forming a US LLC on a budget with bookkeeping and tax add-ons.

Best fit: the low-cost pick for a simple LLC and compliance when you are not raising venture capital and want an affordable all-in-one.

### What it is
A formation service aimed at non-US founders, forming a US LLC, C-Corp or DAO LLC without requiring a US SSN and pairing it with tax and compliance handling. Sold on annual plans starting at $297/yr, with state filing fees and franchise taxes billed on top of the subscription, not inside it.
...
### Choose this if you are…
Ideal for: non-resident solo founders and ecommerce sellers who want formation plus ongoing compliance handled as a yearly service.

Best when: you'd rather pay $297/yr (+ state fees) to keep formation, EIN, registered agent, a US business address and a Mercury banking intro bundled and renewing automatically, and may add a $1,999 tax tier. Choose it over Firstbase when you want an all-in annual compliance subscription over a one-time $399 fee, and over Northwest which won't fully serve non-residents.

Avoid if: you want state fees included up front and cheaper tax filing (go Firstbase's $399 + $899 tax), or you're a US founder raising VC and need a C-corp with a real cap table (go Atlas/Carta).
...
### Built for
Built for: founders and small businesses in any US state needing registered-agent service and LLC or corp filing with strong privacy and human support.

Best fit: best when registered agent and privacy across states is the priority, rather than a startup-specific equity or fundraising toolkit.

### What it is
A registered-agent and privacy provider whose core product is agent service plus a business address and mail scanning, priced at $125/year. Company formation is an optional add-on, not part of the base service, so incorporation itself is not included unless it is purchased separately.
...
### Banking, EIN & bundled services
The bundle centers on a business address and mail scanning at $125/year, not banking or EIN. Those functions sit outside the core registered-agent product, so founders needing an EIN or a bank account handle them elsewhere or through the separate formation add-on.
...
### Choose this if you are…
Ideal for: bootstrapped US founders who want the cheapest, most private LLC and nothing they won't use.

Best when: cost and privacy dominate: roughly $39 + state fee to form and $125/yr for registered agent (about $575+ all-in over five years), with Northwest listing its own address to keep yours off public records; pick it over Firstbase/doola when you're a US resident who doesn't need their non-resident scaffolding, and over Atlas/Clerky when you want a lean LLC instead of a fundraising-ready C-corp.

Avoid if: you're raising venture money and need a Delaware C-corp with 83(b) and a cap table (go Atlas then Carta), or you want banking credits and perks bundled (go Atlas).
...
### Built for
Built for: funded startups and their finance leads managing cap tables, 409A valuations, equity grants, and investor reporting after incorporation.

Best fit: adopt it once you have real equity to administer and investors to report to, not for the day-one filing itself.

### What it is
Carta is a cap-table and equity-management platform; for formation it guides founders to a C-corp or LLC and hands off to an incorporation vendor/law firm, then manages shares, SAFEs, options and 409A valuations.
...
### Choose this if you are…
Ideal for: founders whose day-one priority is clean equity: cap table, 409A readiness, and electronic share issuance for investors and an option pool.

Best when: you've already formed (or will via Atlas/Clerky) and need equity managed properly. Carta Launch is free up to 25 stakeholders and $1M raised, then custom-quoted paid early-stage tiers (no public flat monthly price like "$599/mo"; standalone 409As from ~$3,500) as you grow; choose it over the pure formation tools when your real problem is tracking ownership, SAFEs converting, and vesting, not filing the certificate.
...
### What it is
You act as your own incorporator: draft/adapt Certificate of Incorporation, bylaws, board consents and stock purchase agreements from templates (Cooley GO, Y Combinator, Stripe Atlas open docs) and file directly.

### Structures & states supported
Any structure/state you're willing to research: DE C-corp, LLC, S-corp, home-state entities. No guardrails. You pick and bear the consequences. Delaware C-corp is the standard VC path. Get the wrong one and re-domesticating later is costly.
...
### Choose this if you are…
Ideal for: founders with the time and legal literacy to file directly and keep maximum control over structure and spend.

Best when: you'll submit the Delaware/Wyoming certificate yourself (state fee ~$90-$110), get an EIN free from the IRS, and use startup-lawyer templates (or a flat-fee firm) for bylaws, stock purchase agreements and 83(b); pick this over Atlas/Clerky when you specifically want a custom structure or already have counsel, and over Northwest when you don't even want a service layer.

Avoid if: you're time-poor or unsure about 83(b) timing and founder-stock mechanics; a missed 83(b) window or malformed cap table costs far more than Atlas's $500; go Atlas or Clerky instead.
