# 03 — Newsletter / Marketing Campaigns
...
### Built for
Built for: newsletter creators and media startups, growth-focused writers publishing and monetizing email newsletters with built-in ads, referrals, and audience analytics.

Best fit: creators treating the newsletter as a business who want growth and monetization tools without stitching together separate services.

### What it is
A newsletter platform built around growth and monetization, not plain sending. Alongside the newsletter itself it runs the Boosts ad network and paid subscriptions, and takes a 0% beehiiv cut of paid-subscription revenue (only Stripe's 2.9% + $0.30 applies). Monetization and automations unlock on the Scale plan.
...
### Growth tools
Growth centers on the Boosts ad network, which connects newsletters to acquire subscribers, alongside the newsletter site (custom domains come on every plan, including free Launch). Boosts sits with the monetization tooling on the Scale plan ($43/mo, annual), so the same tier that unlocks revenue also unlocks the paid growth lever.
...
A web-based newsletter editor tied to its newsletter site and branding customization. The sources used here describe it as newsletter-focused and easy to set up. Composition is oriented to writing and sending issues instead of product or transactional templates.
...
Ideal for: founders building a media/newsletter brand who want growth and monetization tooling: non-technical, US/global, scaling a list fast.

Best when: you want built-in referral programs, the Boosts ad network, paid subscriptions, and cross-recommendations to grow, and you'd rather pay a flat fee than share revenue. Launch is free to 2,500 subscribers. Scale (from $43/mo annual) unlocks monetization, automations and Boosts (custom domains come on every plan). Max (from $96/mo annual) adds team and multi-publication features. Enterprise is custom for 100,000+ subscribers.

Avoid if: you're a solo writer who just wants to publish and charge readers with minimal overhead, or you'll balk at the 2,500-sub free cliff; Substack (free, 10% cut) or Kit (10k free subs) are simpler starting points.
...
### Built for
Built for: professional creators and course sellers, non-technical solo operators running email marketing with automations, subscriber tagging, and simple commerce.

Best fit: creators selling digital products who need behavioral automations and paid recommendations beyond basic broadcasting.

### What it is
A creator-focused email marketing tool whose strengths, per the sources used here, are automation and audience size: visual automations and sequences plus a free tier that runs up to 10,000 subscribers before paid plans begin. Formerly ConvertKit, it is a mature creator platform aimed at audience-building over publishing.
...
### Growth tools
Audience-growth tooling, per the sources used here, is forms and landing pages, backed by a large creator-tool ecosystem for integrations. These support list capture instead of viral referral loops. Combined with the 10,000-subscriber free tier, the emphasis is on collecting and nurturing an audience over paid acquisition.

### Automation & segmentation
Automation is Kit's core strength per the sources used here: visual automations and sequences, described as automation-first. This is the primary reason to choose it over a plain broadcast tool: building branching sequences and audience workflows. The sources used here emphasize automation more than detailed segmentation controls.
...
### Choose this if you are…
Ideal for: creators and solo founders monetizing an audience via automations and digital products: non-technical, US/global, list-building focused.

Best when: you want visual automations, tagging, a free tier up to 10k subscribers, and creator commerce (products, referral system). Pick over Mailchimp/MailerLite because creator tooling and deliverability are stronger, but Creator from $39/mo (1k subs), Creator Pro from $79 adds subscriber scoring and referrals.

Avoid if: you're highly price-sensitive at small list sizes (the 2025 hike pushed Creator to a ~$33+ minimum) or want an owned blog/site; MailerLite is cheaper per sub, Ghost gives you a full owned publication, beehiiv gives media-growth tooling.
...
### Built for
Built for: independent publishers and developers, technically comfortable writers running a website plus membership newsletter with paid subscriptions on open-source software.

Best fit: creators wanting to own their full publishing stack and site, and willing to self-host or pay for managed hosting.

### What it is
An open-source publishing platform giving writers a full stack (website, blog, newsletter and paid memberships) via free self-hosting or Ghost(Pro) managed hosting.
...
### Choose this if you are…
Ideal for: founders who want an owned publication plus membership site with 0% revenue share: semi-technical, global, building a blog/newsletter brand.

Best when: you want a full website + newsletter + paid memberships you fully own and to keep 100% of subscription revenue (only Stripe fees). Pick over Substack/beehiiv once you earn more than ~$290/mo, where Ghost Pro's flat fee beats Substack's 10%. Starter $18 (free members only), Publisher $29 (paid memberships), Business $199.

Avoid if: you want a built-in discovery/growth network, or you're non-technical and Starter's default-theme and free-only limits frustrate you; Substack has the network and recommendations, beehiiv has Boosts and referrals.
...
### Built for
Built for: small businesses and solo creators, non-technical marketers sending newsletters and automations with landing pages on a generous free tier.

Best fit: budget-conscious senders who want clean, easy campaign tools without the creator-monetization focus of beehiiv or Kit.

### What it is
A full email marketing platform (Vilnius-based, ~1.5M+ users) covering campaigns, automations, signup forms, landing pages, basic websites, and digital-product/paid-newsletter selling in one dashboard.
...
### Choose this if you are…
Ideal for: budget-conscious SMB and founder marketers who want clean, cheap email plus automation: non-technical, global, ecommerce or simple campaigns.

Best when: you want a low price-per-subscriber with a drag-and-drop builder, automations, and a free plan (now 250 subs / 2,500 sends). Pick over Mailchimp/Kit because it's cheaper (Comfort from ~$12 at 500 subs, Power from ~$25) for comparable features.

Avoid if: you need deep creator commerce, a media-growth network, or an owned publishing site; Kit is stronger for creators, beehiiv for newsletter growth/monetization, Ghost for an owned site. Note the 2026 plan renames (now Comfort and Power) and 10-30% price bump.
...
### Built for
Built for: individual writers and journalists, non-technical creators publishing free and paid newsletters with near-zero setup and built-in discovery.

Best fit: writers who want the fastest path to a paid newsletter and audience network, accepting a revenue cut and limited customization.

### What it is
A publishing platform combining an email newsletter, a hosted website and built-in paid subscriptions. Writers publish posts that go out by email and live on a public archive, with optional podcast and community/chat features.
...
### Choose this if you are…
Ideal for: writers and solo founders who want zero-setup paid newsletters plus built-in discovery: non-technical, US/global, audience-first.

Best when: you want to start free, publish instantly, and tap network effects (recommendations, Notes, discovery) with no monthly fee. Pick over beehiiv/Ghost when reach and simplicity matter and you'd rather trade 10% of revenue than pay for or manage anything, but you keep ~$8.40 on a $10 sub after fees.

Avoid if: your list is large and paid (10% of revenue dwarfs a flat SaaS fee) or you want to own your platform, data, and design; move to Ghost (0% cut, fully owned) or beehiiv (better growth/monetization tooling).
...
### Built for
Built for: small-to-mid businesses and e-commerce sellers, general marketers running email campaigns, automations, and audience management with broad integrations.

Best fit: established SMBs wanting a general-purpose marketing platform with commerce integrations, instead of a creator- or newsletter-first tool.

### What it is
A full email-marketing and automation platform: campaigns, audience management, signup forms, landing pages, basic CRM, and multi-step automations, plus optional SMS, transactional email and (via Intuit) commerce features.

### Pricing & free tier
Free tier cut in Jan 2026 to just 250 contacts and 500 sends/month with no automation. Essentials from $13/mo, Standard from $20/mo, Premium from $350/mo, all priced by contact count, so cost scales steeply as lists grow.
...
### Choose this if you are…
Ideal for: SMBs and non-technical founders wanting all-in-one marketing (email + ecommerce + ads) under a familiar brand: global, B2C/ecommerce.

Best when: you need broad integrations, landing pages, and multichannel marketing on a single well-known platform and want CRM, ads, and ecommerce under one roof instead of a pure email tool. Pick over MailerLite/Kit when breadth of integrations and template library matters most. Essentials from $13, Standard from $20 (500 contacts).
...
### What it is
An open-source newsletter/campaign app you host yourself (Listmonk or Ghost), sending through SES/SMTP instead of a hosted platform like Mailchimp/Beehiiv/Substack. Your server, your subscriber DB.
...
### Automation & segmentation
Listmonk offers SQL-query segments and basic automations. Ghost has simpler tiers/labels. Capable for MVP but not a full journey builder. Complex drip logic means scripting against the API, not clicking a flow UI.
...
### Choose this if you are…
Ideal for: highly technical founders wanting full ownership and near-zero send cost at scale: self-managed infra, any geography.

Best when: your list is large enough that SaaS per-subscriber pricing hurts and you can run Listmonk or self-hosted Ghost on a VPS piping through SES (~$0.10 per 1k emails), but pick over beehiiv/Mailchimp/Kit purely on cost-at-scale and total data ownership.

Avoid if: you don't want to own deliverability, IP warmup, bounce/complaint handling, uptime, and DNS auth (SPF/DKIM/DMARC) yourself; one misconfig tanks inbox rates; for hands-off, use MailerLite (cheap), beehiiv (growth), or Ghost Pro (managed, 0% cut).
